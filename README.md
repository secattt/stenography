...
- [Hướng dẫn tải và kích hoạt các bài lab](#hướng-dẫn-tải-và-kích-hoạt-các-bài-lab)
  - [Ảnh (6 bài)](#ảnh-6-bài)
    ...
    - [1b. stego_lsb_image (uploading ----)](#1b-stego_lsb_image-uploading-----)
    - [2. stego_dct_code (checked)](#2-stego_dct_code-checked)
    - [3. destego_dct_code (checked)](#3-destego_dct_code-checked)
  ...
  - [Tấn công (3 bài)](#tấn-công-3-bài)
    ...
    - [3.stego_code_bpcs_attack1 (checked)](#3stego_code_bpcs_attack1-checked)
  - [Ứng dụng (1 bài)](#ứng-dụng-1-bài)
    - [1. stego-basic-dwt-watermark (checked)](#1-stego-basic-dwt-watermark-checked)
...
```
imodule https://github.com/secattt/stenography/raw/refs/heads/main/video/stego-energy-extract.tar
```

sau đó gõ lệnh sau để kích hoạt:

```
labtainer -r stego-energy-extract
```
...
```
imodule https://github.com/secattt/stenography/raw/refs/heads/main/detect/stegano-detect-bwfw-echo-hiding.tar
```
...
```
imodule https://github.com/secattt/stenography/raw/refs/heads/main/detect/video_detect_qp_stego.tar
```
...
### 1. video-stego-attack-lsb-1 (checked)
...
### 2. stegano-attack-bwfw-echo (checkd)
...
### 3.stego_code_bpcs_attack1 (checked)
...
### 1. stego-basic-dwt-watermark (checked)
